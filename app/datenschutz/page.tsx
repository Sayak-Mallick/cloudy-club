  ...
  return (
    <main style={{ minHeight: "100vh", padding: "120px 40px 80px", background: "var(--bg)" }}>
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "2.75rem", color: "var(--cream)", fontWeight: 500, marginBottom: "8px" }}>Datenschutzerklärung</h1>
        ...
        <div style={{ fontFamily: "Montserrat, sans-serif", fontSize: "0.9375rem", fontWeight: 300, lineHeight: 1.8, color: "var(--text-secondary)" }}>
          {[
            ...
            <div key={i}>
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.25rem", color: "var(--cream)", fontWeight: 500, marginBottom: "12px", marginTop: "40px" }}>{s.title}</h2>
              <p>{s.text}</p>
            </div>
          ))}
